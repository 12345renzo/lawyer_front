        ...
        <table className="w-full">
          ...
          <tbody>
            {recentCases.map((case_) => (
              <tr key={case_.id} className={`border-b transition-colors ${rowClasses}`}>
                <td className="py-3 px-4 font-mono text-sm">#{case_.id}</td>
                <td className="py-3 px-4 font-medium">{case_.title}</td>
                <td className="py-3 px-4">{case_.client}</td>
                ...
                <td className="py-3 px-4 text-sm">{case_.nextDate}</td>
                <td className="py-3 px-4">
                  <div className="flex space-x-2">
                    <Button
                      variant="ghost"
