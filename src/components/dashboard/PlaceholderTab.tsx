...
const PlaceholderTab: React.FC<PlaceholderTabProps> = ({ activeTab, className }) => {
    ...
    switch (tab) {
      case 'clients':
        return {
          ...
          description: 'Esta sección está en desarrollo. Próximamente disponible con todas las funcionalidades.'
        };
      case 'calendar':
        return {
          icon: Calendar,
  ...
  return (
    <div className={`p-6 ${className}`}>
      <div className={`rounded-xl border ${cardClasses} p-12 text-center`}>
        <div className={`w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center ${iconBgClasses}`}>
